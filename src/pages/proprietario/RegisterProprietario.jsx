...
export default function RegisterProprietario({ onLoginProprietario }) {
  ...
  const errors = useMemo(
    () => ({
      ...
      nomeArena: touched.nomeArena
        ? form.nomeArena.trim()
          ? ""
          : "Nome da arena é obrigatório"
        : "",
  ...
  const handleRegister = () => {
    ...
    const errs = {
      ...
      cnpj: validateCNPJ(form.cnpj),
      nomeArena: form.nomeArena.trim() ? "" : "Nome da arena é obrigatório",
    ...
    console.log("Cadastro proprietário payload:", payload);
  ...
  return (
    <Box sx={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      <Box
        sx={{
          background:
            "linear-gradient(160deg, #14532d 0%, #166534 50%, #16a34a 100%)",
          px: 2.5,
          pt: 3,
          pb: 5,
          position: "relative",
      ...
      >
        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
          ...
          <Typography
            sx={{ fontWeight: 800, fontSize: "1.15rem", color: "#fff" }}
          >
      ...
      >
        ...
        <TextField
          label="Nome da arena / estabelecimento"
          fullWidth
          value={form.nomeArena}
          onChange={(e) => handleChange("nomeArena", e.target.value)}
          onBlur={() => handleBlur("nomeArena")}
          error={Boolean(errors.nomeArena)}
          helperText={errors.nomeArena || " "}
          sx={fieldStyle}
        />
        ...
        <TextField
          ...
          helperText={
            errors.senha || "8+ caracteres, 1 maiúscula, 1 número e 1 especial"
          }
